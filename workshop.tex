...
Since it is not part of the core \emph{\proofg}, \texttt{company-coq} can serve as a convenient experimentation area for new features and development directions, before they are merged into \proofg or CoqIDE.
